...
(function() {
  (function() {
    ...
    LRUCache = (function() {
      ...
      LRUCache.prototype.values = function() {
        return this.keys().map((function(_this) {
          return function(key) {
            return _this.hash[key].data.value;
          };
        })(this));
      };
      ...
      LRUCache.prototype.set = function(key, value, onDispose) {
        ...
        if (node) {
          ...
          if (this.size === this.capacity) {
            this.remove(this.linkList.tailNode.data.key);
          }
          node = createNode({
            key: key,
            value: value,
          ...
          this.linkList.insertBeginning(node);
          this.hash[key] = node;
          return this.size++;
        }
      };
      ...
      LRUCache.prototype._refreshNode = function(node) {
        ...
        return this.linkList.moveToHead(node);
      };
    ...
    if (typeof module === 'object' && module.exports) {
      ...
      return console.log('module.exports =', module.exports);
    } else {
      return this.LRUCache = LRUCache;
    }
  })();
